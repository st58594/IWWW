...
<table>
    ...
    foreach (Produkt::getAll() as $item) {
        ?>
        <tr>
            <form class="table-view" method="post" action="./sprava.php" enctype="multipart/form-data">
    ...
    <tr>
        <form class="table-view" method="post" action="./sprava.php" enctype="multipart/form-data">
            ...
            <td>
                <input type="number" name="cena" min="0" step="0.01" placeholder="cena" required>
            </td>
            <td>
                <input type="number" name="mnozstvi" min="1" placeholder="množství" required>
            </td>
            <td>
